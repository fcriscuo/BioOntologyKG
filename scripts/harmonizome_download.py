...
# Python script provided by Harmonizome
# URL: https://maayanlab.cloud/Harmonizome/static/harmonizomedownloader.py
"""---------------------------------------------------------------------------
    ...
    for dataset, path in selected_datasets:
        ...
        for downloadable in selected_downloads:
            ...
            if response.status_code != 200:
                print(f"Unable to download {dataset}: {response.status_code}")
                continue
